...
const dotContent3 = [
  `  <div class="flex">
  <div class="">
      <img class="" src="img/pizza_box.png"/>
...
<div >
  ...
  `
  <div class="z-10" style="background-size: cover; background-position: center; width: 100%; height: 100vh;">
  <img class="z-10" src="img/erp-app-development-service.png"/>
  </div>
  `,
